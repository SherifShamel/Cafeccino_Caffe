...
const num FIGMA_DESIGN_STATUS_BAR = 54;
...
///This method is used to set padding/margin (for the start and end side) & width of the screen or widget according to the Viewport width.
